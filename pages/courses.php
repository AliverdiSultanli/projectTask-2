<html>
<head>
    <title>ITWE - Project 2 - The list of your courses in the current semester in the University of Lodz</title>
...
<section class="secondary">
    <div class="article">
        Type here the list of your courses in the current semester in the University of Lodz
    </div>
    <div class="menu">
        <ul>
            <li>
            ...
            <li>
                <a id="sports" href="sports.php">
                    The list of your favourite sport activities
                </a>
            </li>
            <li>
                <a id="courses" class="active" href="courses.php">
